...
# IIT-Kharagpur EC department
class IIT_KGP_EC(scrapy.Spider):
    # ==== Required Variables: ==== #

    name = 'IIT-KGP-EC'  # Name of spider

    # The allowed domain and the URLs where the spider should start crawling:
    allowed_domains = ["iitkgp.ac.in"]
    start_urls = ['http://www.iitkgp.ac.in/department/EC/faculties']
