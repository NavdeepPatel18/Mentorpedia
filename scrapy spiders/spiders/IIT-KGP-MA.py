...
# IIT-Kharagpur Math department
class IIT_KGP_MA(scrapy.Spider):
    # ==== Required Variables: ==== #

    name = 'IIT-KGP-MA'  # Name of spider

    # The allowed domain and the URLs where the spider should start crawling:
    allowed_domains = ["iitkgp.ac.in"]
    start_urls = ['http://www.iitkgp.ac.in/department/MA/faculties']
    ...
    def get_details(self, response):
        ...
        item['dept'] = "Mathematics department"
        # Research Areas ====
