...
# IIT-Kharagpur Mechanical department
class IIT_KGP_ME(scrapy.Spider):
    # ==== Required Variables: ==== #

    name = 'IIT-KGP-ME'  # Name of spider

    # The allowed domain and the URLs where the spider should start crawling:
    allowed_domains = ["iitkgp.ac.in"]
    start_urls = ['http://www.iitkgp.ac.in/department/ME/faculties']
    ...
    def get_details(self, response):
        ...
        item['dept'] = "Mechanical department"
        # Research Areas ====
